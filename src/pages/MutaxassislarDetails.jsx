...
const MutaxassislarDetails = () => {
  ...
  return (
    <div className='py-0 lg:py-[60px]'>

      <div className="w-full max-w-base mx-auto px-5">
        <Location />

        <div className='flex flex-col lg:flex-row mb-7'>
          <img className='w-full lg:w-[450px] h-full sm:h-[600px] lg:h-full mr-10 rounded-xl shadow-lg shadow-Mos-Purple object-cover' src={TopilganMutaxassis.img} alt="Mutaxassis image" />
          ...
          <div className='space-y-7 mt-6'>
            ...
            <ul className='ml-4 flex flex-col-reverse bizhaqdaResp:flex-row bizhaqdaResp:justify-between'>
              <li className='mr-6 navHiddenResp:px-2 xl:px-0 text-md navHiddenResp:lg xl:text-xl font-normal leading-6 navHiddenResp:leading-7 text-black/80'>
                <p className='-ml-2 lg:-ml-4 text-base lg:text-xl'>{TopilganMutaxassis.aboutJop2.kasalliklari}</p>
                <p className='text-sm lg:text-lg'>{TopilganMutaxassis.aboutJop2.bir}</p>
                <p className='text-sm lg:text-lg'>{TopilganMutaxassis.aboutJop2.ikki}</p>
                <p className='text-sm lg:text-lg'>{TopilganMutaxassis.aboutJop2.uch}</p>
                <p className='text-sm lg:text-lg'>{TopilganMutaxassis.aboutJop2.tort}</p>
                <p className='text-sm lg:text-lg'>{TopilganMutaxassis.aboutJop2.besh}</p>
              </li>
              ...
              <li className='mb-4 bizhaqdaResp:mb-0 navHiddenResp:px-2 xl:px-0 text-md navHiddenResp:lg xl:text-xl font-normal leading-6 navHiddenResp:leading-7 text-black/80'>
                <p className='-ml-2 lg:-ml-4 text-base lg:text-xl'>{TopilganMutaxassis.aboutJop3.kasalliklari}</p>
                <p className='text-sm lg:text-lg'>{TopilganMutaxassis.aboutJop3.bir}</p>
                <p className='text-sm lg:text-lg'>{TopilganMutaxassis.aboutJop3.ikki}</p>
                <p className='text-sm lg:text-lg'>{TopilganMutaxassis.aboutJop3.uch}</p>
                <p className='text-sm lg:text-lg'>{TopilganMutaxassis.aboutJop3.tort}</p>
                <p className='text-sm lg:text-lg'>{TopilganMutaxassis.aboutJop3.besh}</p>
              </li>
            </ul>
