...
import Ultratovush1 from '../img/Ultratovush1.avif'
import Ultratovush2 from '../img/Ultratovush2.avif'
import Ultratovush3 from '../img/Ultratovush3.avif'
import Ultratovush4 from '../img/Ultratovush4.avif'
import Ultratovush5 from '../img/Ultratovush5.avif'
import Ultratovush6 from '../img/Ultratovush6.avif'
    ...
    return (
        <div className='py-7 xl:py-[62px]'>
            ...
            <div className="w-full max-w-base mx-auto px-5 navHiddenResp:px-7 lg:px-5">
                ...
                <h2 className='text-2xl md:text-[37px] lg:text-[45px] xl:text-[50px] font-semibold mb-8 navHiddenResp:mb-10 lg:mb-[50px]'>Ultratovush</h2>
