...
import RentgenNurlari1 from '../img/RentgenNurlari1.avif'
import RentgenNurlari2 from '../img/RentgenNurlari2.jpg'
import RentgenNurlari3 from '../img/RentgenNurlari3.avif'
import RentgenNurlari4 from '../img/RentgenNurlari4.avif'
import RentgenNurlari5 from '../img/RentgenNurlari5.avif'
import RentgenNurlari6 from '../img/RentgenNurlari6.jpg'
    ...
    return (
        <div className='py-7 xl:py-[62px]'>
            ...
            <div className="w-full max-w-base mx-auto px-5 navHiddenResp:px-7 lg:px-5">
                ...
                <h2 className='text-3xl md:text-[37px] lg:text-[45px] xl:text-[50px] font-semibold mb-8 navHiddenResp:mb-10 lg:mb-[50px]'>RengenNurlari</h2>
