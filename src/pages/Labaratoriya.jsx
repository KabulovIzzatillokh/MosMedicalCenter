...
import Labaratoriya1 from '../img/Labaratoriya1.avif'
import Labaratoriya2 from '../img/Labaratoriya2.avif'
import Labaratoriya3 from '../img/Labaratoriya3.jpg'
import Labaratoriya4 from '../img/Labaratoriya4.avif'
import Labaratoriya5 from '../img/Labaratoriya5.jpg'
import Labaratoriya6 from '../img/Labaratoriya6.avif'
    ...
    return (
        <div className='py-7 xl:py-[62px]'>
            ...
            <div className="w-full max-w-base mx-auto px-5 navHiddenResp:px-7 lg:px-5">
                ...
                <h2 className='text-3xl md:text-[37px] lg:text-[45px] xl:text-[50px] font-semibold mb-8 navHiddenResp:mb-10 lg:mb-[50px]'>Labaratoriya</h2>
