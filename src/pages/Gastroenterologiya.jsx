...
import Gastroenterologiya1 from '../img/Gastroenterologiya1.jpg'
import Gastroenterologiya2 from '../img/Gastroenterologiya2.jpg'
import Gastroenterologiya3 from '../img/Gastroenterologiya3.jpg'
import Gastroenterologiya4 from '../img/Gastroenterologiya4.jpg'
import Gastroenterologiya5 from '../img/Gastroenterologiya5.jpg'
import Gastroenterologiya6 from '../img/Gastroenterologiya6.avif'

const Gastroenterologiya = () => {
    ...
    return (
        <div className='py-7 xl:py-[62px]'>
            ...
            <div className="w-full max-w-base mx-auto px-5 navHiddenResp:px-7 lg:px-5">
                ...
                <h2 className='text-[50px} text-3xl md:text-[37px] lg:text-[45px] xl:text-[50px] font-semibold mb-8 navHiddenResp:mb-10 lg:mb-[50px]'>Gastroenterologiya</h2>

                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-10 mb-6 lg:mb-10'>
                    <div className='overflow-hidden rounded-lg'>
                        <img className='object-cover w-[444px] h-[297px] hover:scale-110 transition-all duration-300' src={Gastroenterologiya1} alt="Gastroenterologiya1 image" />
                    </div>
                    <div className='overflow-hidden rounded-lg'>
                        <img className='object-cover w-[444px] h-[297px] hover:scale-110 transition-all duration-300' src={Gastroenterologiya2} alt="Gastroenterologiya2 image" />
                    </div>
                    <div className='overflow-hidden rounded-lg'>
                        <img className='object-cover w-[444px] h-[297px] hover:scale-110 transition-all duration-300' src={Gastroenterologiya3} alt="Gastroenterologiya3 image" />
                    </div>
                    <div className='overflow-hidden rounded-lg'>
                        <img className='object-cover w-[444px] h-[297px] hover:scale-110 transition-all duration-300' src={Gastroenterologiya4} alt="Gastroenterologiya4 image" />
                    </div>
                    <div className='overflow-hidden rounded-lg'>
                        <img className='object-cover w-[444px] h-[297px] hover:scale-110 transition-all duration-300' src={Gastroenterologiya5} alt="Gastroenterologiya5 image" />
                    </div>
                    <div className='overflow-hidden rounded-lg'>
                        <img className='object-cover w-[444px] h-[297px] hover:scale-110 transition-all duration-300' src={Gastroenterologiya6} alt="Gastroenterologiya6 image" />
                    </div>
                </div>
...
export default Gastroenterologiya
