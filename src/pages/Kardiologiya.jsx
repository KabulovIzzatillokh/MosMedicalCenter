            ...
            <div className="w-full max-w-base mx-auto px-5 navHiddenResp:px-7 lg:px-5">
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-10 mb-6 lg:mb-10'>
                    <div className='rounded-lg overflow-hidden'>
                        <img className='object-cover w-[444px] h-[297px] hover:scale-110 transition-all duration-300' src={Kardiologiya1} alt="Kardiologiya1 image" />
                    </div>
                    <div className='rounded-lg overflow-hidden'>
                        <img className='object-cover w-[444px] h-[297px] hover:scale-110 transition-all duration-300' src={Kardiologiya2} alt="Kardiologiya2 image" />
                    </div>
                    <div className='rounded-lg overflow-hidden'>
                        <img className='object-cover w-[444px] h-[297px] hover:scale-110 transition-all duration-300' src={Kardiologiya3} alt="Kardiologiya3 image" />
                    </div>
                    <div className='rounded-lg overflow-hidden'>
                        <img className='object-cover w-[444px] h-[297px] hover:scale-110 transition-all duration-300' src={Kardiologiya4} alt="Kardiologiya4 image" />
                    </div>
                    <div className='rounded-lg overflow-hidden'>
                        <img className='object-cover w-[444px] h-[297px] hover:scale-110 transition-all duration-300' src={Kardiologiya5} alt="Kardiologiya5 image" />
                    </div>
                    <div className='rounded-lg overflow-hidden'>
                        <img className='object-cover w-[444px] h-[297px] hover:scale-110 transition-all duration-300' src={Kardiologiya6} alt="Kardiologiya6 image" />
                    </div>
                </div>
